...
public class MenuPanel extends JPanel {
    ...
    public MenuPanel(Frame frame, Dimension size) {
        ...
        resetButton.setBounds(padding, padding, panelSize.width / 5 - 2 * padding, panelSize.height - 3 * padding);
        ...
        textField.addKeyListener(new KeyAdapter() {
            public void keyPressed(KeyEvent evt) {
                ...
                if (keyCode == VK_TAB) resetButton.requestFocus();
    ...
    private void sendMessage() {
        ...
        // Send Message
        frame.getChatGPT().conversationStream(frame, message);
    }
    ...
    public void setStandby(boolean standby) {
        resetButton.setEnabled(!standby);
    }
}